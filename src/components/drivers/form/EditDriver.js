                            ...
                            <div className="label-value inline">
                                ...
                                <div className="column">
                                    ...
                                    <Field className="regular-input input"
                                           ...
                                           name="lat"
                                    />
                                    {props.touched.lat && props.errors.lat && (
                                        <p className="error-message">{props.errors.lat}</p>
                                    )}
                                    ...
                                    <Field className="regular-input input"
                                           ...
                                           name="long"
                                    />
                                    {props.touched.long && props.errors.long && (
                                        <p className="error-message">{props.errors.long}</p>
                                    )}
